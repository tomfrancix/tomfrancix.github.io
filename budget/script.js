...
//CHECK  {console.log("button was clicked")});  /*for when the enter key is pressed*/
  ...
  //console.log(event); check keyCode number for enter document.querySelector(DOM.inputBtn).addEventListener('click', ctrlAddItem);      document.querySelector(DOM.container).addEventListener('click', ctrlDeleteItem);
